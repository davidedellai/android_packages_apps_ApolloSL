...
public class RecentWidgetProvider extends AppWidgetBase {
    ...
    public static final String CLICK_ACTION = "com.sokp.boom.recents.appwidget.action.CLICK";

    public static final String REFRESH_ACTION = "com.sokp.boom.recents.appwidget.action.REFRESH";
