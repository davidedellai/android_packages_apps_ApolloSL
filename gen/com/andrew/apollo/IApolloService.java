...
{
private static final java.lang.String DESCRIPTOR = "com.andrew.apollo.IApolloService";
...
static final int TRANSACTION_toggleFavorite = (android.os.IBinder.FIRST_CALL_TRANSACTION + 12);
static final int TRANSACTION_refresh = (android.os.IBinder.FIRST_CALL_TRANSACTION + 13);
static final int TRANSACTION_isFavorite = (android.os.IBinder.FIRST_CALL_TRANSACTION + 14);
static final int TRANSACTION_isPlaying = (android.os.IBinder.FIRST_CALL_TRANSACTION + 15);
static final int TRANSACTION_getQueue = (android.os.IBinder.FIRST_CALL_TRANSACTION + 16);
static final int TRANSACTION_duration = (android.os.IBinder.FIRST_CALL_TRANSACTION + 17);
static final int TRANSACTION_position = (android.os.IBinder.FIRST_CALL_TRANSACTION + 18);
static final int TRANSACTION_seek = (android.os.IBinder.FIRST_CALL_TRANSACTION + 19);
static final int TRANSACTION_getAudioId = (android.os.IBinder.FIRST_CALL_TRANSACTION + 20);
static final int TRANSACTION_getArtistId = (android.os.IBinder.FIRST_CALL_TRANSACTION + 21);
static final int TRANSACTION_getAlbumId = (android.os.IBinder.FIRST_CALL_TRANSACTION + 22);
static final int TRANSACTION_getArtistName = (android.os.IBinder.FIRST_CALL_TRANSACTION + 23);
static final int TRANSACTION_getTrackName = (android.os.IBinder.FIRST_CALL_TRANSACTION + 24);
static final int TRANSACTION_getAlbumName = (android.os.IBinder.FIRST_CALL_TRANSACTION + 25);
static final int TRANSACTION_getPath = (android.os.IBinder.FIRST_CALL_TRANSACTION + 26);
static final int TRANSACTION_getQueuePosition = (android.os.IBinder.FIRST_CALL_TRANSACTION + 27);
